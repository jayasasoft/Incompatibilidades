...
$t_pa_consanguinidad_add = NULL; // Initialize page object first

class ct_pa_consanguinidad_add extends ct_pa_consanguinidad {
	...
	// Page object name
	var $PageObjName = 't_pa_consanguinidad_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_pa_consanguinidadview.php")
...
// Create page object
if (!isset($t_pa_consanguinidad_add)) $t_pa_consanguinidad_add = new ct_pa_consanguinidad_add();

// Page init
$t_pa_consanguinidad_add->Page_Init();

// Page main
$t_pa_consanguinidad_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_pa_consanguinidad_add->Page_Render();
?>
...
var CurrentForm = ft_pa_consanguinidadadd = new ew_Form("ft_pa_consanguinidadadd", "add");

// Validate form
ft_pa_consanguinidadadd.Validate = function() {
...
ft_pa_consanguinidadadd.Form_CustomValidate = 
...
ft_pa_consanguinidadadd.ValidateRequired = true;
<?php } else { ?>
ft_pa_consanguinidadadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_pa_consanguinidadadd.Lists["x_Parentesco"] = {"LinkField":"x_Parentesco","Ajax":true,"AutoFill":false,"DisplayFields":["x_Parentesco","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"s_consanguineo"};
...
<?php if (!$t_pa_consanguinidad_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_pa_consanguinidad_add->ShowPageHeader(); ?>
<?php
$t_pa_consanguinidad_add->ShowMessage();
?>
<form name="ft_pa_consanguinidadadd" id="ft_pa_consanguinidadadd" class="<?php echo $t_pa_consanguinidad_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_pa_consanguinidad_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_pa_consanguinidad_add->Token ?>">
<?php } ?>
...
<?php if ($t_pa_consanguinidad->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group">
		<label id="elh_t_pa_consanguinidad_Id" for="x_Id" class="col-sm-2 control-label ewLabel"><?php echo $t_pa_consanguinidad->Id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php } else { ?>
<span id="el_t_pa_consanguinidad_Id">
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Id" data-page="1" name="x_Id" id="x_Id" size="30" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Id->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Id->EditValue ?>"<?php echo $t_pa_consanguinidad->Id->EditAttributes() ?>>
</span>
<?php } ?>
...
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Nombres" data-page="1" name="x_Nombres" id="x_Nombres" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Nombres->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Nombres->EditValue ?>"<?php echo $t_pa_consanguinidad->Nombres->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Apellido_Paterno" data-page="1" name="x_Apellido_Paterno" id="x_Apellido_Paterno" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Apellido_Paterno->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Apellido_Paterno->EditValue ?>"<?php echo $t_pa_consanguinidad->Apellido_Paterno->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Apellido_Materno" data-page="1" name="x_Apellido_Materno" id="x_Apellido_Materno" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Apellido_Materno->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Apellido_Materno->EditValue ?>"<?php echo $t_pa_consanguinidad->Apellido_Materno->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_pa_consanguinidad_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_pa_consanguinidadadd.Init();
</script>
<?php
$t_pa_consanguinidad_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_pa_consanguinidad_add->Page_Terminate();
?>
