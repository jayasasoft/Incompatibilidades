...
//
// Table class for t_pa_afinidad
//
class ct_pa_afinidad extends cTable {
	var $Id;
	var $Nombre;
	...
	function __construct() {
		...
		$this->TableVar = 't_pa_afinidad';
		$this->TableName = 't_pa_afinidad';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_pa_afinidad`";
		$this->DBID = 'DB';
		...
		// Id
		$this->Id = new cField('t_pa_afinidad', 't_pa_afinidad', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Id->Sortable = TRUE; // Allow sort
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// Nombre
		$this->Nombre = new cField('t_pa_afinidad', 't_pa_afinidad', 'x_Nombre', 'Nombre', '`Nombre`', '`Nombre`', 200, -1, FALSE, '`Nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombre->Sortable = TRUE; // Allow sort
		$this->fields['Nombre'] = &$this->Nombre;

		// Apellido_Paterno
		$this->Apellido_Paterno = new cField('t_pa_afinidad', 't_pa_afinidad', 'x_Apellido_Paterno', 'Apellido_Paterno', '`Apellido_Paterno`', '`Apellido_Paterno`', 200, -1, FALSE, '`Apellido_Paterno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Paterno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Paterno'] = &$this->Apellido_Paterno;

		// Apellido_Materno
		$this->Apellido_Materno = new cField('t_pa_afinidad', 't_pa_afinidad', 'x_Apellido_Materno', 'Apellido_Materno', '`Apellido_Materno`', '`Apellido_Materno`', 200, -1, FALSE, '`Apellido_Materno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Materno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Materno'] = &$this->Apellido_Materno;

		// Grado_Parentesco
		$this->Grado_Parentesco = new cField('t_pa_afinidad', 't_pa_afinidad', 'x_Grado_Parentesco', 'Grado_Parentesco', '`Grado_Parentesco`', '`Grado_Parentesco`', 200, -1, FALSE, '`Grado_Parentesco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_pa_afinidad`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_pa_afinidadview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_pa_afinidadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_pa_afinidadadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_pa_afinidadadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_pa_afinidadedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_pa_afinidadadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_pa_afinidaddelete.php", $this->UrlParm());
	}
