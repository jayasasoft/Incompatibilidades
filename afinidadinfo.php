...
//
// Table class for afinidad
//
class cafinidad extends cTable {
	var $Nombre;
	...
	function __construct() {
		...
		$this->TableVar = 'afinidad';
		$this->TableName = 'afinidad';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`afinidad`";
		$this->DBID = 'DB';
		...
		// Nombre
		$this->Nombre = new cField('afinidad', 'afinidad', 'x_Nombre', 'Nombre', '`Nombre`', '`Nombre`', 200, -1, FALSE, '`Nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombre->Sortable = TRUE; // Allow sort
		$this->fields['Nombre'] = &$this->Nombre;

		// Apellido_Paterno
		$this->Apellido_Paterno = new cField('afinidad', 'afinidad', 'x_Apellido_Paterno', 'Apellido_Paterno', '`Apellido_Paterno`', '`Apellido_Paterno`', 200, -1, FALSE, '`Apellido_Paterno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Paterno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Paterno'] = &$this->Apellido_Paterno;

		// Apellido_Materno
		$this->Apellido_Materno = new cField('afinidad', 'afinidad', 'x_Apellido_Materno', 'Apellido_Materno', '`Apellido_Materno`', '`Apellido_Materno`', 200, -1, FALSE, '`Apellido_Materno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Materno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Materno'] = &$this->Apellido_Materno;

		// Grado_Parentesco
		$this->Grado_Parentesco = new cField('afinidad', 'afinidad', 'x_Grado_Parentesco', 'Grado_Parentesco', '`Grado_Parentesco`', '`Grado_Parentesco`', 200, -1, FALSE, '`Grado_Parentesco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->Grado_Parentesco->OptionCount = 3;
		$this->fields['Grado_Parentesco'] = &$this->Grado_Parentesco;

		// CI_RUN
		$this->CI_RUN = new cField('afinidad', 'afinidad', 'x_CI_RUN', 'CI_RUN', '`CI_RUN`', '`CI_RUN`', 200, -1, FALSE, '`CI_RUN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CI_RUN->Sortable = TRUE; // Allow sort
		$this->fields['CI_RUN'] = &$this->CI_RUN;

		// Expedido
		$this->Expedido = new cField('afinidad', 'afinidad', 'x_Expedido', 'Expedido', '`Expedido`', '`Expedido`', 200, -1, FALSE, '`Expedido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Expedido->Sortable = TRUE; // Allow sort
		$this->fields['Expedido'] = &$this->Expedido;

		// Apellido_Paterno1
		$this->Apellido_Paterno1 = new cField('afinidad', 'afinidad', 'x_Apellido_Paterno1', 'Apellido_Paterno1', '`Apellido_Paterno1`', '`Apellido_Paterno1`', 200, -1, FALSE, '`Apellido_Paterno1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Paterno1->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Paterno1'] = &$this->Apellido_Paterno1;

		// Apellido_Materno1
		$this->Apellido_Materno1 = new cField('afinidad', 'afinidad', 'x_Apellido_Materno1', 'Apellido_Materno1', '`Apellido_Materno1`', '`Apellido_Materno1`', 200, -1, FALSE, '`Apellido_Materno1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Materno1->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Materno1'] = &$this->Apellido_Materno1;

		// Nombres
		$this->Nombres = new cField('afinidad', 'afinidad', 'x_Nombres', 'Nombres', '`Nombres`', '`Nombres`', 200, -1, FALSE, '`Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Nombres'] = &$this->Nombres;

		// Cargo
		$this->Cargo = new cField('afinidad', 'afinidad', 'x_Cargo', 'Cargo', '`Cargo`', '`Cargo`', 200, -1, FALSE, '`Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cargo->Sortable = TRUE; // Allow sort
		$this->fields['Cargo'] = &$this->Cargo;

		// Unidad
		$this->Unidad = new cField('afinidad', 'afinidad', 'x_Unidad', 'Unidad', '`Unidad`', '`Unidad`', 200, -1, FALSE, '`Unidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Unidad->Sortable = TRUE; // Allow sort
		$this->fields['Unidad'] = &$this->Unidad;

		// Fiscalia_otro
		$this->Fiscalia_otro = new cField('afinidad', 'afinidad', 'x_Fiscalia_otro', 'Fiscalia_otro', '`Fiscalia_otro`', '`Fiscalia_otro`', 200, -1, FALSE, '`Fiscalia_otro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fiscalia_otro->Sortable = TRUE; // Allow sort
		$this->fields['Fiscalia_otro'] = &$this->Fiscalia_otro;

		// Unidad_Organizacional
		$this->Unidad_Organizacional = new cField('afinidad', 'afinidad', 'x_Unidad_Organizacional', 'Unidad_Organizacional', '`Unidad_Organizacional`', '`Unidad_Organizacional`', 200, -1, FALSE, '`Unidad_Organizacional`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`afinidad`";
	}
	...
	function SqlKeyFilter() {
		return "`Nombre` = '@Nombre@' AND `Apellido_Paterno` = '@Apellido_Paterno@' AND `Apellido_Materno` = '@Apellido_Materno@'";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("afinidadview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("afinidadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "afinidadadd.php?" . $this->UrlParm($parm);
		else
			$url = "afinidadadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("afinidadedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("afinidadadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("afinidaddelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["Nombre"]))
				$arKey[] = ew_StripSlashes($_POST["Nombre"]);
			elseif (isset($_GET["Nombre"]))
				$arKey[] = ew_StripSlashes($_GET["Nombre"]);
			else
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->Nombre->CurrentValue = $key[0];
