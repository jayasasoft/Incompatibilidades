...
$t_pa_afinidad_update = NULL; // Initialize page object first

class ct_pa_afinidad_update extends ct_pa_afinidad {
	...
	// Page object name
	var $PageObjName = 't_pa_afinidad_update';
	...
	function Page_Main() {
		...
		if (count($this->RecKeys) <= 0)
			$this->Page_Terminate("t_pa_afinidadlist.php"); // No records selected, return to list
...
// Create page object
if (!isset($t_pa_afinidad_update)) $t_pa_afinidad_update = new ct_pa_afinidad_update();

// Page init
$t_pa_afinidad_update->Page_Init();

// Page main
$t_pa_afinidad_update->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_pa_afinidad_update->Page_Render();
?>
...
var CurrentForm = ft_pa_afinidadupdate = new ew_Form("ft_pa_afinidadupdate", "update");

// Validate form
ft_pa_afinidadupdate.Validate = function() {
...
ft_pa_afinidadupdate.Form_CustomValidate = 
...
ft_pa_afinidadupdate.ValidateRequired = true;
<?php } else { ?>
ft_pa_afinidadupdate.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_pa_afinidadupdate.Lists["x_Grado_Parentesco"] = {"LinkField":"x_Parentesco","Ajax":true,"AutoFill":false,"DisplayFields":["x_Parentesco","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"s_afinidad"};
...
<?php if (!$t_pa_afinidad_update->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_pa_afinidad_update->ShowPageHeader(); ?>
<?php
$t_pa_afinidad_update->ShowMessage();
?>
<form name="ft_pa_afinidadupdate" id="ft_pa_afinidadupdate" class="<?php echo $t_pa_afinidad_update->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_pa_afinidad_update->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_pa_afinidad_update->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_pa_afinidad">
<?php if ($t_pa_afinidad->CurrentAction == "F") { // Confirm page ?>
...
<?php } ?>
<?php foreach ($t_pa_afinidad_update->RecKeys as $key) { ?>
<?php $keyvalue = is_array($key) ? implode($EW_COMPOSITE_KEY_SEPARATOR, $key) : $key; ?>
<input type="hidden" name="key_m[]" value="<?php echo ew_HtmlEncode($keyvalue) ?>">
<?php } ?>
<div id="tbl_t_pa_afinidadupdate">
	<div class="checkbox">
		<label><input type="checkbox" name="u" id="u" onclick="ew_SelectAll(this);"<?php echo $t_pa_afinidad_update->Disabled ?>> <?php echo $Language->Phrase("UpdateSelectAll") ?></label>
	</div>
<?php if ($t_pa_afinidad->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group">
		<label for="x_Id" class="col-sm-2 control-label">
<?php if ($t_pa_afinidad->CurrentAction <> "F") { ?>
<input type="checkbox" name="u_Id" id="u_Id" value="1"<?php echo ($t_pa_afinidad->Id->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($t_pa_afinidad->Id->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Id" id="u_Id" value="<?php echo $t_pa_afinidad->Id->MultiUpdate ?>">
<?php } ?>
 <?php echo $t_pa_afinidad->Id->FldCaption() ?></label>
...
<input type="hidden" id="x_Id" name="x_Id" value="<?php echo ew_HtmlEncode($t_pa_afinidad->Id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_t_pa_afinidad_Id">
...
<input type="hidden" data-table="t_pa_afinidad" data-field="x_Id" name="x_Id" id="x_Id" value="<?php echo ew_HtmlEncode($t_pa_afinidad->Id->FormValue) ?>">
<?php } ?>
<?php echo $t_pa_afinidad->Id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($t_pa_afinidad->CurrentAction <> "F") { ?>
<input type="checkbox" name="u_Grado_Parentesco" id="u_Grado_Parentesco" value="1"<?php echo ($t_pa_afinidad->Grado_Parentesco->MultiUpdate == "1") ? " checked" : "" ?>>
<?php } else { ?>
<input type="checkbox" disabled<?php echo ($t_pa_afinidad->Grado_Parentesco->MultiUpdate == "1") ? " checked" : "" ?>>
<input type="hidden" name="u_Grado_Parentesco" id="u_Grado_Parentesco" value="<?php echo $t_pa_afinidad->Grado_Parentesco->MultiUpdate ?>">
<?php } ?>
 <?php echo $t_pa_afinidad->Grado_Parentesco->FldCaption() ?></label>
...
<input type="hidden" data-table="t_pa_afinidad" data-field="x_Grado_Parentesco" name="x_Grado_Parentesco" id="x_Grado_Parentesco" value="<?php echo ew_HtmlEncode($t_pa_afinidad->Grado_Parentesco->FormValue) ?>">
<?php } ?>
<?php echo $t_pa_afinidad->Grado_Parentesco->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if (!$t_pa_afinidad_update->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_pa_afinidad_update->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<script type="text/javascript">
ft_pa_afinidadupdate.Init();
</script>
<?php
$t_pa_afinidad_update->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_pa_afinidad_update->Page_Terminate();
?>
