...
$t_declaraciones = NULL;

//
// Table class for t_declaraciones
//
class ct_declaraciones extends cTable {
	var $CI_RUN;
	var $Fecha;
	var $Archivo;
	...
	function __construct() {
		...
		$this->TableVar = 't_declaraciones';
		$this->TableName = 't_declaraciones';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_declaraciones`";
		$this->DBID = 'DB';
		...
		// CI_RUN
		$this->CI_RUN = new cField('t_declaraciones', 't_declaraciones', 'x_CI_RUN', 'CI_RUN', '`CI_RUN`', '`CI_RUN`', 200, -1, FALSE, '`CI_RUN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Fecha
		$this->Fecha = new cField('t_declaraciones', 't_declaraciones', 'x_Fecha', 'Fecha', '`Fecha`', ew_CastDateFieldForLike('`Fecha`', 12, "DB"), 133, 12, FALSE, '`Fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fecha->Sortable = TRUE; // Allow sort
		$this->Fecha->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectShortDateYMD"));
		$this->fields['Fecha'] = &$this->Fecha;

		// Archivo
		$this->Archivo = new cField('t_declaraciones', 't_declaraciones', 'x_Archivo', 'Archivo', '`Archivo`', '`Archivo`', 200, -1, FALSE, '`Archivo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_declaraciones`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_declaracioneslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_declaracionesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_declaracionesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_declaracionesadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_declaracionesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_declaracionesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_declaracionesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_declaracionesdelete.php", $this->UrlParm());
	}
