...
$t_pa_consanguinidad_delete = NULL; // Initialize page object first

class ct_pa_consanguinidad_delete extends ct_pa_consanguinidad {
	...
	// Page object name
	var $PageObjName = 't_pa_consanguinidad_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t_pa_consanguinidadlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t_pa_consanguinidad class, t_pa_consanguinidadinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t_pa_consanguinidadlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t_pa_consanguinidad_delete)) $t_pa_consanguinidad_delete = new ct_pa_consanguinidad_delete();

// Page init
$t_pa_consanguinidad_delete->Page_Init();

// Page main
$t_pa_consanguinidad_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_pa_consanguinidad_delete->Page_Render();
?>
...
var CurrentForm = ft_pa_consanguinidaddelete = new ew_Form("ft_pa_consanguinidaddelete", "delete");

// Form_CustomValidate event
ft_pa_consanguinidaddelete.Form_CustomValidate = 
...
ft_pa_consanguinidaddelete.ValidateRequired = true;
<?php } else { ?>
ft_pa_consanguinidaddelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_pa_consanguinidaddelete.Lists["x_Parentesco"] = {"LinkField":"x_Parentesco","Ajax":true,"AutoFill":false,"DisplayFields":["x_Parentesco","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"s_consanguineo"};
...
<?php $t_pa_consanguinidad_delete->ShowPageHeader(); ?>
<?php
$t_pa_consanguinidad_delete->ShowMessage();
?>
<form name="ft_pa_consanguinidaddelete" id="ft_pa_consanguinidaddelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_pa_consanguinidad_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_pa_consanguinidad_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_pa_consanguinidad">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t_pa_consanguinidad_delete->RecKeys as $key) { ?>
...
<?php if ($t_pa_consanguinidad->Id->Visible) { // Id ?>
		<th><span id="elh_t_pa_consanguinidad_Id" class="t_pa_consanguinidad_Id"><?php echo $t_pa_consanguinidad->Id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_pa_consanguinidad->Nombres->Visible) { // Nombres ?>
		<th><span id="elh_t_pa_consanguinidad_Nombres" class="t_pa_consanguinidad_Nombres"><?php echo $t_pa_consanguinidad->Nombres->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_pa_consanguinidad->Apellido_Paterno->Visible) { // Apellido_Paterno ?>
		<th><span id="elh_t_pa_consanguinidad_Apellido_Paterno" class="t_pa_consanguinidad_Apellido_Paterno"><?php echo $t_pa_consanguinidad->Apellido_Paterno->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_pa_consanguinidad->Apellido_Materno->Visible) { // Apellido_Materno ?>
		<th><span id="elh_t_pa_consanguinidad_Apellido_Materno" class="t_pa_consanguinidad_Apellido_Materno"><?php echo $t_pa_consanguinidad->Apellido_Materno->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_pa_consanguinidad->Parentesco->Visible) { // Parentesco ?>
		<th><span id="elh_t_pa_consanguinidad_Parentesco" class="t_pa_consanguinidad_Parentesco"><?php echo $t_pa_consanguinidad->Parentesco->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t_pa_consanguinidad_delete->RecCnt = 0;
$i = 0;
while (!$t_pa_consanguinidad_delete->Recordset->EOF) {
	$t_pa_consanguinidad_delete->RecCnt++;
	$t_pa_consanguinidad_delete->RowCnt++;

	// Set row properties
	$t_pa_consanguinidad->ResetAttrs();
	$t_pa_consanguinidad->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t_pa_consanguinidad_delete->LoadRowValues($t_pa_consanguinidad_delete->Recordset);

	// Render row
	$t_pa_consanguinidad_delete->RenderRow();
?>
	<tr<?php echo $t_pa_consanguinidad->RowAttributes() ?>>
<?php if ($t_pa_consanguinidad->Id->Visible) { // Id ?>
		<td<?php echo $t_pa_consanguinidad->Id->CellAttributes() ?>>
<span id="el<?php echo $t_pa_consanguinidad_delete->RowCnt ?>_t_pa_consanguinidad_Id" class="t_pa_consanguinidad_Id">
...
<span id="el<?php echo $t_pa_consanguinidad_delete->RowCnt ?>_t_pa_consanguinidad_Nombres" class="t_pa_consanguinidad_Nombres">
...
<span id="el<?php echo $t_pa_consanguinidad_delete->RowCnt ?>_t_pa_consanguinidad_Apellido_Paterno" class="t_pa_consanguinidad_Apellido_Paterno">
...
<span id="el<?php echo $t_pa_consanguinidad_delete->RowCnt ?>_t_pa_consanguinidad_Apellido_Materno" class="t_pa_consanguinidad_Apellido_Materno">
...
<span id="el<?php echo $t_pa_consanguinidad_delete->RowCnt ?>_t_pa_consanguinidad_Parentesco" class="t_pa_consanguinidad_Parentesco">
...
<?php
	$t_pa_consanguinidad_delete->Recordset->MoveNext();
}
$t_pa_consanguinidad_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_pa_consanguinidad_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft_pa_consanguinidaddelete.Init();
</script>
<?php
$t_pa_consanguinidad_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_pa_consanguinidad_delete->Page_Terminate();
?>
