...
$t_conyugue_add = NULL; // Initialize page object first

class ct_conyugue_add extends ct_conyugue {
	...
	// Page object name
	var $PageObjName = 't_conyugue_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_conyugueview.php")
...
// Create page object
if (!isset($t_conyugue_add)) $t_conyugue_add = new ct_conyugue_add();

// Page init
$t_conyugue_add->Page_Init();

// Page main
$t_conyugue_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_conyugue_add->Page_Render();
?>
...
var CurrentForm = ft_conyugueadd = new ew_Form("ft_conyugueadd", "add");

// Validate form
ft_conyugueadd.Validate = function() {
...
ft_conyugueadd.Form_CustomValidate = 
...
ft_conyugueadd.ValidateRequired = true;
<?php } else { ?>
ft_conyugueadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_conyugueadd.Lists["x_Expedido"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_conyugueadd.Lists["x_Expedido"].Options = <?php echo json_encode($t_conyugue->Expedido->Options()) ?>;
...
<?php } ?>
<?php $t_conyugue_add->ShowPageHeader(); ?>
<?php
$t_conyugue_add->ShowMessage();
?>
<form name="ft_conyugueadd" id="ft_conyugueadd" class="<?php echo $t_conyugue_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_conyugue_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_conyugue_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="t_conyugue" data-field="x_CI_RUN" data-page="1" name="x_CI_RUN" id="x_CI_RUN" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($t_conyugue->CI_RUN->getPlaceHolder()) ?>" value="<?php echo $t_conyugue->CI_RUN->EditValue ?>"<?php echo $t_conyugue->CI_RUN->EditAttributes() ?>>
</span>
...
<?php if (strval($t_conyugue->Id->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_Id" id="x_Id" value="<?php echo ew_HtmlEncode(strval($t_conyugue->Id->getSessionValue())) ?>">
<?php } ?>
<?php if (!$t_conyugue_add->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_conyugue_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
