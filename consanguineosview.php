...
$consanguineos_view = NULL; // Initialize page object first

class cconsanguineos_view extends cconsanguineos {
	...
	// Page object name
	var $PageObjName = 'consanguineos_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["Nombres"] <> "") {
			$this->RecKey["Nombres"] = $_GET["Nombres"];
			$KeyUrl .= "&amp;Nombres=" . urlencode($this->RecKey["Nombres"]);
		}
		if (@$_GET["Apellido_Paterno"] <> "") {
			$this->RecKey["Apellido_Paterno"] = $_GET["Apellido_Paterno"];
			$KeyUrl .= "&amp;Apellido_Paterno=" . urlencode($this->RecKey["Apellido_Paterno"]);
		}
		if (@$_GET["Apellido_Materno"] <> "") {
			$this->RecKey["Apellido_Materno"] = $_GET["Apellido_Materno"];
			$KeyUrl .= "&amp;Apellido_Materno=" . urlencode($this->RecKey["Apellido_Materno"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["Nombres"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["Nombres"]);
		}
		if (@$_GET["Apellido_Paterno"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["Apellido_Paterno"]);
		}
		if (@$_GET["Apellido_Materno"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= ew_StripSlashes($_GET["Apellido_Materno"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Nombres"] <> "") {
				...
				$this->RecKey["Nombres"] = $this->Nombres->QueryStringValue;
			} elseif (@$_POST["Nombres"] <> "") {
				$this->Nombres->setFormValue($_POST["Nombres"]);
				$this->RecKey["Nombres"] = $this->Nombres->FormValue;
			} else {
				$sReturnUrl = "consanguineoslist.php"; // Return to list
			}
			if (@$_GET["Apellido_Paterno"] <> "") {
				$this->Apellido_Paterno->setQueryStringValue($_GET["Apellido_Paterno"]);
				$this->RecKey["Apellido_Paterno"] = $this->Apellido_Paterno->QueryStringValue;
			} elseif (@$_POST["Apellido_Paterno"] <> "") {
				$this->Apellido_Paterno->setFormValue($_POST["Apellido_Paterno"]);
				$this->RecKey["Apellido_Paterno"] = $this->Apellido_Paterno->FormValue;
			} else {
				$sReturnUrl = "consanguineoslist.php"; // Return to list
			}
			if (@$_GET["Apellido_Materno"] <> "") {
				$this->Apellido_Materno->setQueryStringValue($_GET["Apellido_Materno"]);
				$this->RecKey["Apellido_Materno"] = $this->Apellido_Materno->QueryStringValue;
			} elseif (@$_POST["Apellido_Materno"] <> "") {
				$this->Apellido_Materno->setFormValue($_POST["Apellido_Materno"]);
				$this->RecKey["Apellido_Materno"] = $this->Apellido_Materno->FormValue;
			} else {
				$sReturnUrl = "consanguineoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "consanguineoslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "consanguineoslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($consanguineos_view)) $consanguineos_view = new cconsanguineos_view();

// Page init
$consanguineos_view->Page_Init();

// Page main
$consanguineos_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$consanguineos_view->Page_Render();
?>
...
var CurrentForm = fconsanguineosview = new ew_Form("fconsanguineosview", "view");

// Form_CustomValidate event
fconsanguineosview.Form_CustomValidate = 
...
fconsanguineosview.ValidateRequired = true;
<?php } else { ?>
fconsanguineosview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fconsanguineosview.Lists["x_Parentesco"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fconsanguineosview.Lists["x_Parentesco"].Options = <?php echo json_encode($consanguineos->Parentesco->Options()) ?>;
...
<?php if ($consanguineos->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$consanguineos_view->IsModal) { ?>
<?php if ($consanguineos->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $consanguineos_view->ExportOptions->Render("body") ?>
<?php
	foreach ($consanguineos_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$consanguineos_view->IsModal) { ?>
<?php if ($consanguineos->Export == "") { ?>
...
<?php } ?>
<?php $consanguineos_view->ShowPageHeader(); ?>
<?php
$consanguineos_view->ShowMessage();
?>
<form name="fconsanguineosview" id="fconsanguineosview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($consanguineos_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $consanguineos_view->Token ?>">
<?php } ?>
...
<?php if ($consanguineos->CI_RUN->Visible) { // CI_RUN ?>
	<tr id="r_CI_RUN">
		<td><span id="elh_consanguineos_CI_RUN"><?php echo $consanguineos->CI_RUN->FldCaption() ?></span></td>
...
<?php echo $consanguineos->CI_RUN->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Expedido->Visible) { // Expedido ?>
	<tr id="r_Expedido">
		<td><span id="elh_consanguineos_Expedido"><?php echo $consanguineos->Expedido->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Expedido->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Nombres1->Visible) { // Nombres1 ?>
	<tr id="r_Nombres1">
		<td><span id="elh_consanguineos_Nombres1"><?php echo $consanguineos->Nombres1->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Nombres1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Apellido_Paterno1->Visible) { // Apellido_Paterno1 ?>
	<tr id="r_Apellido_Paterno1">
		<td><span id="elh_consanguineos_Apellido_Paterno1"><?php echo $consanguineos->Apellido_Paterno1->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Apellido_Paterno1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Apellido_Materno1->Visible) { // Apellido_Materno1 ?>
	<tr id="r_Apellido_Materno1">
		<td><span id="elh_consanguineos_Apellido_Materno1"><?php echo $consanguineos->Apellido_Materno1->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Apellido_Materno1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Fiscalia_otro->Visible) { // Fiscalia_otro ?>
	<tr id="r_Fiscalia_otro">
		<td><span id="elh_consanguineos_Fiscalia_otro"><?php echo $consanguineos->Fiscalia_otro->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Fiscalia_otro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Unidad_Organizacional->Visible) { // Unidad_Organizacional ?>
	<tr id="r_Unidad_Organizacional">
		<td><span id="elh_consanguineos_Unidad_Organizacional"><?php echo $consanguineos->Unidad_Organizacional->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Unidad_Organizacional->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Cargo->Visible) { // Cargo ?>
	<tr id="r_Cargo">
		<td><span id="elh_consanguineos_Cargo"><?php echo $consanguineos->Cargo->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Cargo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Unidad->Visible) { // Unidad ?>
	<tr id="r_Unidad">
		<td><span id="elh_consanguineos_Unidad"><?php echo $consanguineos->Unidad->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Unidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Nombres->Visible) { // Nombres ?>
	<tr id="r_Nombres">
		<td><span id="elh_consanguineos_Nombres"><?php echo $consanguineos->Nombres->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Nombres->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Apellido_Paterno->Visible) { // Apellido_Paterno ?>
	<tr id="r_Apellido_Paterno">
		<td><span id="elh_consanguineos_Apellido_Paterno"><?php echo $consanguineos->Apellido_Paterno->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Apellido_Paterno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Apellido_Materno->Visible) { // Apellido_Materno ?>
	<tr id="r_Apellido_Materno">
		<td><span id="elh_consanguineos_Apellido_Materno"><?php echo $consanguineos->Apellido_Materno->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Apellido_Materno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consanguineos->Parentesco->Visible) { // Parentesco ?>
	<tr id="r_Parentesco">
		<td><span id="elh_consanguineos_Parentesco"><?php echo $consanguineos->Parentesco->FldCaption() ?></span></td>
...
<?php echo $consanguineos->Parentesco->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($consanguineos->Export == "") { ?>
<script type="text/javascript">
fconsanguineosview.Init();
</script>
<?php } ?>
<?php
$consanguineos_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($consanguineos->Export == "") { ?>
...
<?php
$consanguineos_view->Page_Terminate();
?>
