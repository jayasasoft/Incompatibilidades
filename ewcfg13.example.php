...
define("EW_PROJECT_NAME", "Incompatibilidad", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{DBEDEDF3-C0F6-4CE5-A781-F1E2EFAF0B48}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'iWFOjVuxr4lB09by', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Incompatibilidad.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "bd_incompatibilidades", "qs" => "`", "qe" => "`");
...
define("EW_SESSION_TIMEOUT", 30, TRUE); // Session timeout time (minutes)
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "`audittrail2`", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "audittrail2", TRUE); // Audit trail table var
...
// Security
define("EW_ADMIN_USER_NAME", "Javier", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "Javier", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`t_usuario`", TRUE);
define("EW_USER_NAME_FILTER", "(`Usuario` = '%u')", TRUE);
define("EW_USER_ID_FILTER", "(`Codigo_usuario` = '%u')", TRUE);
...
// Auto hide pager
define("EW_AUTO_HIDE_PAGER", FALSE, TRUE);

// Email
define("EW_SMTP_SERVER", "smtp.mailtrap.io", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 2525, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "", TRUE);
define("EW_SMTP_SERVER_USERNAME", "4b2684bd6a30da", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "211da118a7ede3", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", " 67a7586ed0-8ef97b@inbox.mailtrap.io", TRUE); // Sender email address
define("EW_RECIPIENT_EMAIL", " 67a7586ed0-8ef97b@inbox.mailtrap.io", TRUE); // Recipient email address
define("EW_MAX_EMAIL_RECIPIENT", 15, TRUE);
define("EW_MAX_EMAIL_SENT_COUNT", 15, TRUE);
...
// Page Title Style
define("EW_PAGE_TITLE_STYLE", "Caption", TRUE);
