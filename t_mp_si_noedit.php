...
$t_mp_si_no_edit = NULL; // Initialize page object first

class ct_mp_si_no_edit extends ct_mp_si_no {
	...
	// Page object name
	var $PageObjName = 't_mp_si_no_edit';
	...
	function Page_Main() {
		...
		if (@$_GET["Grado"] <> "") {
			$this->Grado->setQueryStringValue($_GET["Grado"]);
		}
		...
		if ($this->Id->CurrentValue == "") {
			$this->Page_Terminate("t_mp_si_nolist.php"); // Invalid key, return to list
		}
		if ($this->Grado->CurrentValue == "") {
			$this->Page_Terminate("t_mp_si_nolist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->Grado_Si->SetDbValueDef($rsnew, $this->Grado_Si->CurrentValue, NULL, $this->Grado_Si->ReadOnly);

			// Grado_No
			$this->Grado_No->SetDbValueDef($rsnew, $this->Grado_No->CurrentValue, NULL, $this->Grado_No->ReadOnly);
...
// Create page object
if (!isset($t_mp_si_no_edit)) $t_mp_si_no_edit = new ct_mp_si_no_edit();

// Page init
$t_mp_si_no_edit->Page_Init();

// Page main
$t_mp_si_no_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_mp_si_no_edit->Page_Render();
?>
...
var CurrentForm = ft_mp_si_noedit = new ew_Form("ft_mp_si_noedit", "edit");

// Validate form
ft_mp_si_noedit.Validate = function() {
...
ft_mp_si_noedit.Form_CustomValidate = 
...
ft_mp_si_noedit.ValidateRequired = true;
<?php } else { ?>
ft_mp_si_noedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_mp_si_noedit.Lists["x_Grado_Si[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_mp_si_noedit.Lists["x_Grado_Si[]"].Options = <?php echo json_encode($t_mp_si_no->Grado_Si->Options()) ?>;
ft_mp_si_noedit.Lists["x_Grado_No[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_mp_si_noedit.Lists["x_Grado_No[]"].Options = <?php echo json_encode($t_mp_si_no->Grado_No->Options()) ?>;
...
<?php if (!$t_mp_si_no_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_mp_si_no_edit->ShowPageHeader(); ?>
<?php
$t_mp_si_no_edit->ShowMessage();
?>
<form name="ft_mp_si_noedit" id="ft_mp_si_noedit" class="<?php echo $t_mp_si_no_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_mp_si_no_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_mp_si_no_edit->Token ?>">
<?php } ?>
...
<?php if ($t_mp_si_no->Grado->Visible) { // Grado ?>
	<div id="r_Grado" class="form-group">
		<label id="elh_t_mp_si_no_Grado" for="x_Grado" class="col-sm-2 control-label ewLabel"><?php echo $t_mp_si_no->Grado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<input type="hidden" data-table="t_mp_si_no" data-field="x_Grado" data-page="1" name="x_Grado" id="x_Grado" value="<?php echo ew_HtmlEncode($t_mp_si_no->Grado->CurrentValue) ?>">
...
<div id="tp_x_Grado_Si" class="ewTemplate"><input type="checkbox" data-table="t_mp_si_no" data-field="x_Grado_Si" data-page="1" data-value-separator="<?php echo $t_mp_si_no->Grado_Si->DisplayValueSeparatorAttribute() ?>" name="x_Grado_Si[]" id="x_Grado_Si[]" value="{value}"<?php echo $t_mp_si_no->Grado_Si->EditAttributes() ?>></div>
<div id="dsl_x_Grado_Si" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $t_mp_si_no->Grado_Si->CheckBoxListHtml(FALSE, "x_Grado_Si[]", 1) ?>
</div></div>
</span>
...
<div id="tp_x_Grado_No" class="ewTemplate"><input type="checkbox" data-table="t_mp_si_no" data-field="x_Grado_No" data-page="1" data-value-separator="<?php echo $t_mp_si_no->Grado_No->DisplayValueSeparatorAttribute() ?>" name="x_Grado_No[]" id="x_Grado_No[]" value="{value}"<?php echo $t_mp_si_no->Grado_No->EditAttributes() ?>></div>
<div id="dsl_x_Grado_No" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $t_mp_si_no->Grado_No->CheckBoxListHtml(FALSE, "x_Grado_No[]", 1) ?>
</div></div>
</span>
...
<input type="hidden" data-table="t_mp_si_no" data-field="x_Id" name="x_Id" id="x_Id" value="<?php echo ew_HtmlEncode($t_mp_si_no->Id->CurrentValue) ?>">
<?php if (!$t_mp_si_no_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_mp_si_no_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_mp_si_noedit.Init();
</script>
<?php
$t_mp_si_no_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_mp_si_no_edit->Page_Terminate();
?>
