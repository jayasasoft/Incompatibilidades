...
$t_pa_afinidad_grid = NULL; // Initialize page object first

class ct_pa_afinidad_grid extends ct_pa_afinidad {
	...
	// Page object name
	var $PageObjName = 't_pa_afinidad_grid';

	// Grid form hidden field names
	var $FormName = 'ft_pa_afinidadgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_pa_afinidad"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadOldRecord() {
		...
		if ($cnt >= 3) {
			if (strval($arKeys[0]) <> "")
				$this->Nombre->CurrentValue = strval($arKeys[0]); // Nombre
			else
				$bValidKey = FALSE;
			if (strval($arKeys[1]) <> "")
