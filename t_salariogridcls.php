...
$t_salario_grid = NULL; // Initialize page object first

class ct_salario_grid extends ct_salario {
	...
	// Page object name
	var $PageObjName = 't_salario_grid';

	// Grid form hidden field names
	var $FormName = 'ft_salariogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_salario"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_Id") && $objForm->HasValue("o_Id") && $this->Id->CurrentValue <> $this->Id->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Salario_Mayor_Si") && $objForm->HasValue("o_Salario_Mayor_Si") && $this->Salario_Mayor_Si->CurrentValue <> $this->Salario_Mayor_Si->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_Salario_Mayor_No") && $objForm->HasValue("o_Salario_Mayor_No") && $this->Salario_Mayor_No->CurrentValue <> $this->Salario_Mayor_No->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadDefaultValues() {
		...
		$this->Salario_Mayor_Si->OldValue = $this->Salario_Mayor_Si->CurrentValue;
		$this->Salario_Mayor_No->CurrentValue = NULL;
		$this->Salario_Mayor_No->OldValue = $this->Salario_Mayor_No->CurrentValue;
	}
	...
	function LoadFormValues() {
		...
		$this->Salario_Mayor_Si->setOldValue($objForm->GetValue("o_Salario_Mayor_Si"));
		if (!$this->Salario_Mayor_No->FldIsDetailKey) {
			$this->Salario_Mayor_No->setFormValue($objForm->GetValue("x_Salario_Mayor_No"));
		}
		$this->Salario_Mayor_No->setOldValue($objForm->GetValue("o_Salario_Mayor_No"));
	}
	...
	function AddRow($rsold = NULL) {
		...
		// Salario_Mayor_Si
		$this->Salario_Mayor_Si->SetDbValueDef($rsnew, $this->Salario_Mayor_Si->CurrentValue, NULL, FALSE);

		// Salario_Mayor_No
		$this->Salario_Mayor_No->SetDbValueDef($rsnew, $this->Salario_Mayor_No->CurrentValue, NULL, FALSE);
