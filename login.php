...
class clogin extends ct_usuario {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t_usuario"])) $GLOBALS["t_usuario"] = &$this;
...
var txt11 = "Si Ud.  no tiene una cuenta debe ir al enlace Registrarse";
var txt2 = "RECUPERAR CLAVE: ";
var txt22 = "Si olvido su clave, puede ir al enlace Recuperar contraseña, y visualizar su clave en su email";
var txt3 = "INICIAR SESION: ";
var txt33 = "Si ya tiene un nombre de usuario y clave vaya al enlace Iniciar Sesión";
document.write("<hr/>");
