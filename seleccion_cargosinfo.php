...
$seleccion_cargos = NULL;

//
// Table class for seleccion_cargos
//
class cseleccion_cargos extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'seleccion_cargos';
		$this->TableName = 'seleccion_cargos';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`seleccion_cargos`";
		$this->DBID = 'DB';
		...
		$this->Unidad_Organizacional = new cField('seleccion_cargos', 'seleccion_cargos', 'x_Unidad_Organizacional', 'Unidad_Organizacional', '`Unidad_Organizacional`', '`Unidad_Organizacional`', 200, -1, FALSE, '`Unidad_Organizacional`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Unidad_Organizacional->Sortable = TRUE; // Allow sort
		$this->fields['Unidad_Organizacional'] = &$this->Unidad_Organizacional;

		// Unidad
		$this->Unidad = new cField('seleccion_cargos', 'seleccion_cargos', 'x_Unidad', 'Unidad', '`Unidad`', '`Unidad`', 200, -1, FALSE, '`Unidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Unidad->Sortable = TRUE; // Allow sort
		$this->fields['Unidad'] = &$this->Unidad;

		// Cargo
		$this->Cargo = new cField('seleccion_cargos', 'seleccion_cargos', 'x_Cargo', 'Cargo', '`Cargo`', '`Cargo`', 200, -1, FALSE, '`Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cargo->Sortable = TRUE; // Allow sort
		$this->fields['Cargo'] = &$this->Cargo;

		// Fiscalia
		$this->Fiscalia = new cField('seleccion_cargos', 'seleccion_cargos', 'x_Fiscalia', 'Fiscalia', '`Fiscalia`', '`Fiscalia`', 200, -1, FALSE, '`Fiscalia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`seleccion_cargos`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "seleccion_cargoslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("seleccion_cargosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("seleccion_cargosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "seleccion_cargosadd.php?" . $this->UrlParm($parm);
		else
			$url = "seleccion_cargosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("seleccion_cargosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("seleccion_cargosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("seleccion_cargosdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->Fiscalia->EditValue = $this->Fiscalia->CurrentValue;
		$this->Fiscalia->PlaceHolder = ew_RemoveHtml($this->Fiscalia->FldCaption());
