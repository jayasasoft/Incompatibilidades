...
$t_mp_si_no_view = NULL; // Initialize page object first

class ct_mp_si_no_view extends ct_mp_si_no {
	...
	// Page object name
	var $PageObjName = 't_mp_si_no_view';
	...
	function __construct() {
		...
		if (@$_GET["Grado"] <> "") {
			$this->RecKey["Grado"] = $_GET["Grado"];
			$KeyUrl .= "&amp;Grado=" . urlencode($this->RecKey["Grado"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t_mp_si_nolist.php"; // Return to list
			}
			if (@$_GET["Grado"] <> "") {
				$this->Grado->setQueryStringValue($_GET["Grado"]);
				$this->RecKey["Grado"] = $this->Grado->QueryStringValue;
			} elseif (@$_POST["Grado"] <> "") {
				$this->Grado->setFormValue($_POST["Grado"]);
				$this->RecKey["Grado"] = $this->Grado->FormValue;
			} else {
				$sReturnUrl = "t_mp_si_nolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t_mp_si_nolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t_mp_si_nolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_mp_si_no_view)) $t_mp_si_no_view = new ct_mp_si_no_view();

// Page init
$t_mp_si_no_view->Page_Init();

// Page main
$t_mp_si_no_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_mp_si_no_view->Page_Render();
?>
...
var CurrentForm = ft_mp_si_noview = new ew_Form("ft_mp_si_noview", "view");

// Form_CustomValidate event
ft_mp_si_noview.Form_CustomValidate = 
...
ft_mp_si_noview.ValidateRequired = true;
<?php } else { ?>
ft_mp_si_noview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_mp_si_noview.Lists["x_grado_Si[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_mp_si_noview.Lists["x_grado_Si[]"].Options = <?php echo json_encode($t_mp_si_no->grado_Si->Options()) ?>;
ft_mp_si_noview.Lists["x_grado_No[]"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_mp_si_noview.Lists["x_grado_No[]"].Options = <?php echo json_encode($t_mp_si_no->grado_No->Options()) ?>;
...
<div class="ewToolbar">
<?php if (!$t_mp_si_no_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t_mp_si_no_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_mp_si_no_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_mp_si_no_view->IsModal) { ?>
...
<?php $t_mp_si_no_view->ShowPageHeader(); ?>
<?php
$t_mp_si_no_view->ShowMessage();
?>
<form name="ft_mp_si_noview" id="ft_mp_si_noview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_mp_si_no_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_mp_si_no_view->Token ?>">
<?php } ?>
...
<?php if ($t_mp_si_no->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t_mp_si_no_id"><?php echo $t_mp_si_no->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $t_mp_si_no->id->CellAttributes() ?>>
<span id="el_t_mp_si_no_id" data-page="1">
<span<?php echo $t_mp_si_no->id->ViewAttributes() ?>>
<?php echo $t_mp_si_no->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_mp_si_no->Grado->Visible) { // Grado ?>
	<tr id="r_Grado">
		<td><span id="elh_t_mp_si_no_Grado"><?php echo $t_mp_si_no->Grado->FldCaption() ?></span></td>
		<td data-name="Grado"<?php echo $t_mp_si_no->Grado->CellAttributes() ?>>
<span id="el_t_mp_si_no_Grado" data-page="1">
<span<?php echo $t_mp_si_no->Grado->ViewAttributes() ?>>
<?php echo $t_mp_si_no->Grado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_mp_si_no->grado_Si->Visible) { // grado_Si ?>
	<tr id="r_grado_Si">
		<td><span id="elh_t_mp_si_no_grado_Si"><?php echo $t_mp_si_no->grado_Si->FldCaption() ?></span></td>
		<td data-name="grado_Si"<?php echo $t_mp_si_no->grado_Si->CellAttributes() ?>>
<span id="el_t_mp_si_no_grado_Si" data-page="1">
<span<?php echo $t_mp_si_no->grado_Si->ViewAttributes() ?>>
<?php echo $t_mp_si_no->grado_Si->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_mp_si_no->grado_No->Visible) { // grado_No ?>
	<tr id="r_grado_No">
		<td><span id="elh_t_mp_si_no_grado_No"><?php echo $t_mp_si_no->grado_No->FldCaption() ?></span></td>
		<td data-name="grado_No"<?php echo $t_mp_si_no->grado_No->CellAttributes() ?>>
<span id="el_t_mp_si_no_grado_No" data-page="1">
<span<?php echo $t_mp_si_no->grado_No->ViewAttributes() ?>>
<?php echo $t_mp_si_no->grado_No->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft_mp_si_noview.Init();
</script>
<?php
$t_mp_si_no_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_mp_si_no_view->Page_Terminate();
?>
