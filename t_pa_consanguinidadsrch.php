...
$t_pa_consanguinidad_search = NULL; // Initialize page object first

class ct_pa_consanguinidad_search extends ct_pa_consanguinidad {
	...
	// Page object name
	var $PageObjName = 't_pa_consanguinidad_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "t_pa_consanguinidadlist.php" . "?" . $sSrchStr;
	...
	function RenderRow() {
		...
		$this->Parentesco->ViewCustomAttributes = "";
			...
			if (trim(strval($this->Parentesco->AdvancedSearch->SearchValue)) == "") {
				$sFilterWrk = "0=1";
			} else {
				$sFilterWrk = "`Parentesco`" . ew_SearchString("=", $this->Parentesco->AdvancedSearch->SearchValue, EW_DATATYPE_STRING, "");
			}
...
// Create page object
if (!isset($t_pa_consanguinidad_search)) $t_pa_consanguinidad_search = new ct_pa_consanguinidad_search();

// Page init
$t_pa_consanguinidad_search->Page_Init();

// Page main
$t_pa_consanguinidad_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_pa_consanguinidad_search->Page_Render();
?>
...
<?php if ($t_pa_consanguinidad_search->IsModal) { ?>
var CurrentAdvancedSearchForm = ft_pa_consanguinidadsearch = new ew_Form("ft_pa_consanguinidadsearch", "search");
<?php } else { ?>
var CurrentForm = ft_pa_consanguinidadsearch = new ew_Form("ft_pa_consanguinidadsearch", "search");
<?php } ?>

// Form_CustomValidate event
ft_pa_consanguinidadsearch.Form_CustomValidate = 
...
ft_pa_consanguinidadsearch.ValidateRequired = true;
<?php } else { ?>
ft_pa_consanguinidadsearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_pa_consanguinidadsearch.Lists["x_Parentesco"] = {"LinkField":"x_Parentesco","Ajax":true,"AutoFill":false,"DisplayFields":["x_Parentesco","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"s_consanguineo"};

// Form object for search
// Validate function for search

ft_pa_consanguinidadsearch.Validate = function(fobj) {
...
<?php } ?>
<?php $t_pa_consanguinidad_search->ShowPageHeader(); ?>
<?php
$t_pa_consanguinidad_search->ShowMessage();
?>
<form name="ft_pa_consanguinidadsearch" id="ft_pa_consanguinidadsearch" class="<?php echo $t_pa_consanguinidad_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_pa_consanguinidad_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_pa_consanguinidad_search->Token ?>">
<?php } ?>
...
<?php if ($t_pa_consanguinidad->Id->Visible) { // Id ?>
	<div id="r_Id" class="form-group">
		<label for="x_Id" class="<?php echo $t_pa_consanguinidad_search->SearchLabelClass ?>"><span id="elh_t_pa_consanguinidad_Id"><?php echo $t_pa_consanguinidad->Id->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Id" id="z_Id" value="="></p>
		</label>
		<div class="<?php echo $t_pa_consanguinidad_search->SearchRightColumnClass ?>"><div<?php echo $t_pa_consanguinidad->Id->CellAttributes() ?>>
...
<?php if ($t_pa_consanguinidad->Nombres->Visible) { // Nombres ?>
	<div id="r_Nombres" class="form-group">
		<label for="x_Nombres" class="<?php echo $t_pa_consanguinidad_search->SearchLabelClass ?>"><span id="elh_t_pa_consanguinidad_Nombres"><?php echo $t_pa_consanguinidad->Nombres->FldCaption() ?></span>	
		...
		<div class="<?php echo $t_pa_consanguinidad_search->SearchRightColumnClass ?>"><div<?php echo $t_pa_consanguinidad->Nombres->CellAttributes() ?>>
			<span id="el_t_pa_consanguinidad_Nombres">
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Nombres" name="x_Nombres" id="x_Nombres" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Nombres->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Nombres->EditValue ?>"<?php echo $t_pa_consanguinidad->Nombres->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($t_pa_consanguinidad->Apellido_Paterno->Visible) { // Apellido_Paterno ?>
	<div id="r_Apellido_Paterno" class="form-group">
		<label for="x_Apellido_Paterno" class="<?php echo $t_pa_consanguinidad_search->SearchLabelClass ?>"><span id="elh_t_pa_consanguinidad_Apellido_Paterno"><?php echo $t_pa_consanguinidad->Apellido_Paterno->FldCaption() ?></span>	
		...
		<div class="<?php echo $t_pa_consanguinidad_search->SearchRightColumnClass ?>"><div<?php echo $t_pa_consanguinidad->Apellido_Paterno->CellAttributes() ?>>
			<span id="el_t_pa_consanguinidad_Apellido_Paterno">
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Apellido_Paterno" name="x_Apellido_Paterno" id="x_Apellido_Paterno" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Apellido_Paterno->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Apellido_Paterno->EditValue ?>"<?php echo $t_pa_consanguinidad->Apellido_Paterno->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($t_pa_consanguinidad->Apellido_Materno->Visible) { // Apellido_Materno ?>
	<div id="r_Apellido_Materno" class="form-group">
		<label for="x_Apellido_Materno" class="<?php echo $t_pa_consanguinidad_search->SearchLabelClass ?>"><span id="elh_t_pa_consanguinidad_Apellido_Materno"><?php echo $t_pa_consanguinidad->Apellido_Materno->FldCaption() ?></span>	
		...
		<div class="<?php echo $t_pa_consanguinidad_search->SearchRightColumnClass ?>"><div<?php echo $t_pa_consanguinidad->Apellido_Materno->CellAttributes() ?>>
			<span id="el_t_pa_consanguinidad_Apellido_Materno">
<input type="text" data-table="t_pa_consanguinidad" data-field="x_Apellido_Materno" name="x_Apellido_Materno" id="x_Apellido_Materno" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($t_pa_consanguinidad->Apellido_Materno->getPlaceHolder()) ?>" value="<?php echo $t_pa_consanguinidad->Apellido_Materno->EditValue ?>"<?php echo $t_pa_consanguinidad->Apellido_Materno->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($t_pa_consanguinidad->Parentesco->Visible) { // Parentesco ?>
	<div id="r_Parentesco" class="form-group">
		<label for="x_Parentesco" class="<?php echo $t_pa_consanguinidad_search->SearchLabelClass ?>"><span id="elh_t_pa_consanguinidad_Parentesco"><?php echo $t_pa_consanguinidad->Parentesco->FldCaption() ?></span>	
		...
		<div class="<?php echo $t_pa_consanguinidad_search->SearchRightColumnClass ?>"><div<?php echo $t_pa_consanguinidad->Parentesco->CellAttributes() ?>>
...
<script type="text/javascript">
ft_pa_consanguinidadsearch.Init();
</script>
<?php
$t_pa_consanguinidad_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_pa_consanguinidad_search->Page_Terminate();
?>
