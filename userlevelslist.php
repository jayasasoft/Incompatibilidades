...
class cuserlevels_list extends cuserlevels {
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->userlevelid->CurrentValue) . "\">";
...
<form name="fuserlevelslist" id="fuserlevelslist" class="form-horizontal ewForm ewListForm ewMultiColumnForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
?>
<?php echo $userlevels_list->MultiColumnBeginGrid() ?>
<div class="<?php echo $userlevels_list->MultiColumnClass ?>"<?php echo $userlevels->RowAttributes() ?>>
	...
	<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
		<?php if ($userlevels->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="userlevels_userlevelid">
<?php if ($userlevels->Export <> "" || $userlevels->SortUrl($userlevels->userlevelid) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $userlevels->userlevelid->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->userlevelid) ?>',1);">
...
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_userlevelid">
...
<?php echo $userlevels->userlevelid->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group userlevels_userlevelid">
			<label class="col-sm-2 control-label ewLabel"><?php echo $userlevels->userlevelid->FldCaption() ?></label>
...
<?php echo $userlevels->userlevelid->ListViewValue() ?></span>
	...
	<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
		<?php if ($userlevels->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="userlevels_userlevelname">
<?php if ($userlevels->Export <> "" || $userlevels->SortUrl($userlevels->userlevelname) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $userlevels->userlevelname->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->userlevelname) ?>',1);">
...
<span id="el<?php echo $userlevels_list->RowCnt ?>_userlevels_userlevelname">
...
<?php echo $userlevels->userlevelname->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group userlevels_userlevelname">
			<label class="col-sm-2 control-label ewLabel"><?php echo $userlevels->userlevelname->FldCaption() ?></label>
...
$userlevels_list->ListOptions->Render("body", "", $userlevels_list->RowCnt);
?>
</div>
<div class="clearfix"></div>
</div>
...
?>
<?php echo $userlevels_list->MultiColumnEndGrid() ?>
<div class="clearfix"></div>
<?php } ?>
