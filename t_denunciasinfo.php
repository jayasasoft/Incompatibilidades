...
//
// Table class for t_denuncias
//
class ct_denuncias extends cTable {
	var $CI_RUN;
	var $Fecha_denuncia;
	...
	function __construct() {
		...
		$this->TableVar = 't_denuncias';
		$this->TableName = 't_denuncias';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_denuncias`";
		$this->DBID = 'DB';
		...
		// CI_RUN
		$this->CI_RUN = new cField('t_denuncias', 't_denuncias', 'x_CI_RUN', 'CI_RUN', '`CI_RUN`', '`CI_RUN`', 200, -1, FALSE, '`CI_RUN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CI_RUN->Sortable = TRUE; // Allow sort
		$this->fields['CI_RUN'] = &$this->CI_RUN;

		// Fecha_denuncia
		$this->Fecha_denuncia = new cField('t_denuncias', 't_denuncias', 'x_Fecha_denuncia', 'Fecha_denuncia', '`Fecha_denuncia`', ew_CastDateFieldForLike('`Fecha_denuncia`', 0, "DB"), 133, 0, FALSE, '`Fecha_denuncia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nombres_Apellidos
		$this->Nombres_Apellidos = new cField('t_denuncias', 't_denuncias', 'x_Nombres_Apellidos', 'Nombres_Apellidos', '`Nombres_Apellidos`', '`Nombres_Apellidos`', 200, -1, FALSE, '`Nombres_Apellidos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombres_Apellidos->Sortable = FALSE; // Allow sort
		$this->fields['Nombres_Apellidos'] = &$this->Nombres_Apellidos;

		// Unidad_Organizacional
		$this->Unidad_Organizacional = new cField('t_denuncias', 't_denuncias', 'x_Unidad_Organizacional', 'Unidad_Organizacional', '`Unidad_Organizacional`', '`Unidad_Organizacional`', 200, -1, FALSE, '`Unidad_Organizacional`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Unidad_Organizacional->Sortable = FALSE; // Allow sort
		$this->fields['Unidad_Organizacional'] = &$this->Unidad_Organizacional;

		// Detalles
		$this->Detalles = new cField('t_denuncias', 't_denuncias', 'x_Detalles', 'Detalles', '`Detalles`', '`Detalles`', 201, -1, FALSE, '`Detalles`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_denuncias`";
	}
	...
	function SqlKeyFilter() {
		return "`CI_RUN` = '@CI_RUN@' AND `Fecha_denuncia` = '@Fecha_denuncia@' AND `Nombres_Apellidos` = '@Nombres_Apellidos@'";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_denunciasview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_denunciasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_denunciasadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_denunciasadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_denunciasedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_denunciasadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_denunciasdelete.php", $this->UrlParm());
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->Fecha_denuncia->CurrentValue = $key[1];
			$this->Nombres_Apellidos->CurrentValue = $key[2];
