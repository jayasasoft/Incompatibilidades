...
class cforgotpwd extends ct_usuario {
...
<?php } ?>
	<div class="form-group">
		...
		<div class="col-sm-10"><input type="text" name="email" id="email" class="form-control ewControl" value="<?php echo ew_HtmlEncode($forgotpwd->Email) ?>" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("UserEmail")) ?>"></div>
	</div>
	<div class="form-group">
