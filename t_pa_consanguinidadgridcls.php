...
$t_pa_consanguinidad_grid = NULL; // Initialize page object first

class ct_pa_consanguinidad_grid extends ct_pa_consanguinidad {
	...
	// Page object name
	var $PageObjName = 't_pa_consanguinidad_grid';

	// Grid form hidden field names
	var $FormName = 'ft_pa_consanguinidadgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_pa_consanguinidad"];
