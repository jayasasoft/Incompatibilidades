...
$t_unidad_organizacional_edit = NULL; // Initialize page object first

class ct_unidad_organizacional_edit extends ct_unidad_organizacional {
	...
	// Page object name
	var $PageObjName = 't_unidad_organizacional_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->Id_Unidad_Org->CurrentValue == "") {
			$this->Page_Terminate("t_unidad_organizacionallist.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("t_unidad", $DetailTblVar) && $GLOBALS["t_unidad"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("t_unidad", $DetailTblVar) && $GLOBALS["t_unidad"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["t_unidad_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t_unidad", $DetailTblVar)) {
				...
				if ($GLOBALS["t_unidad_grid"]->DetailEdit) {
					$GLOBALS["t_unidad_grid"]->CurrentMode = "edit";
					$GLOBALS["t_unidad_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($t_unidad_organizacional_edit)) $t_unidad_organizacional_edit = new ct_unidad_organizacional_edit();

// Page init
$t_unidad_organizacional_edit->Page_Init();

// Page main
$t_unidad_organizacional_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_unidad_organizacional_edit->Page_Render();
?>
...
var CurrentForm = ft_unidad_organizacionaledit = new ew_Form("ft_unidad_organizacionaledit", "edit");

// Validate form
ft_unidad_organizacionaledit.Validate = function() {
...
ft_unidad_organizacionaledit.Form_CustomValidate = 
...
ft_unidad_organizacionaledit.ValidateRequired = true;
<?php } else { ?>
ft_unidad_organizacionaledit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t_unidad_organizacional_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_unidad_organizacional_edit->ShowPageHeader(); ?>
<?php
$t_unidad_organizacional_edit->ShowMessage();
?>
<form name="ft_unidad_organizacionaledit" id="ft_unidad_organizacionaledit" class="<?php echo $t_unidad_organizacional_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_unidad_organizacional_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_unidad_organizacional_edit->Token ?>">
<?php } ?>
...
<?php if ($t_unidad_organizacional->Id_Unidad_Org->Visible) { // Id_Unidad_Org ?>
	<div id="r_Id_Unidad_Org" class="form-group">
		<label id="elh_t_unidad_organizacional_Id_Unidad_Org" class="col-sm-2 control-label ewLabel"><?php echo $t_unidad_organizacional->Id_Unidad_Org->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_unidad_organizacional->Id_Unidad_Org->CellAttributes() ?>>
<span id="el_t_unidad_organizacional_Id_Unidad_Org">
<span<?php echo $t_unidad_organizacional->Id_Unidad_Org->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t_unidad_organizacional->Id_Unidad_Org->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t_unidad_organizacional" data-field="x_Id_Unidad_Org" data-page="1" name="x_Id_Unidad_Org" id="x_Id_Unidad_Org" value="<?php echo ew_HtmlEncode($t_unidad_organizacional->Id_Unidad_Org->CurrentValue) ?>">
<?php echo $t_unidad_organizacional->Id_Unidad_Org->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php
	if (in_array("t_unidad", explode(",", $t_unidad_organizacional->getCurrentDetailTable())) && $t_unidad->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_unidad_organizacional_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_unidad_organizacionaledit.Init();
</script>
<?php
$t_unidad_organizacional_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_unidad_organizacional_edit->Page_Terminate();
?>
