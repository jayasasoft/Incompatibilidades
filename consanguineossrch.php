...
$consanguineos_search = NULL; // Initialize page object first

class cconsanguineos_search extends cconsanguineos {
	...
	// Page object name
	var $PageObjName = 'consanguineos_search';
	...
	function Page_Init() {
		...
		if (!$Security->CanSearch()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("consanguineoslist.php"));
			else
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "consanguineoslist.php" . "?" . $sSrchStr;
	...
	function RenderRow() {
		...
		$this->Parentesco->ViewCustomAttributes = "";
			...
			$this->Parentesco->EditValue = $this->Parentesco->Options(TRUE);
		}
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, $this->AddMasterUrl("consanguineoslist.php"), "", $this->TableVar, TRUE);
		$PageId = "search";
...
// Create page object
if (!isset($consanguineos_search)) $consanguineos_search = new cconsanguineos_search();

// Page init
$consanguineos_search->Page_Init();

// Page main
$consanguineos_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$consanguineos_search->Page_Render();
?>
...
<?php if ($consanguineos_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fconsanguineossearch = new ew_Form("fconsanguineossearch", "search");
<?php } else { ?>
var CurrentForm = fconsanguineossearch = new ew_Form("fconsanguineossearch", "search");
<?php } ?>

// Form_CustomValidate event
fconsanguineossearch.Form_CustomValidate = 
...
fconsanguineossearch.ValidateRequired = true;
<?php } else { ?>
fconsanguineossearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fconsanguineossearch.Lists["x_Parentesco"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fconsanguineossearch.Lists["x_Parentesco"].Options = <?php echo json_encode($consanguineos->Parentesco->Options()) ?>;

// Form object for search
// Validate function for search

fconsanguineossearch.Validate = function(fobj) {
...
<?php } ?>
<?php $consanguineos_search->ShowPageHeader(); ?>
<?php
$consanguineos_search->ShowMessage();
?>
<form name="fconsanguineossearch" id="fconsanguineossearch" class="<?php echo $consanguineos_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($consanguineos_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $consanguineos_search->Token ?>">
<?php } ?>
...
<?php if ($consanguineos->CI_RUN->Visible) { // CI_RUN ?>
	<div id="r_CI_RUN" class="form-group">
		<label for="x_CI_RUN" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_CI_RUN"><?php echo $consanguineos->CI_RUN->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->CI_RUN->CellAttributes() ?>>
			<span id="el_consanguineos_CI_RUN">
<input type="text" data-table="consanguineos" data-field="x_CI_RUN" name="x_CI_RUN" id="x_CI_RUN" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($consanguineos->CI_RUN->getPlaceHolder()) ?>" value="<?php echo $consanguineos->CI_RUN->EditValue ?>"<?php echo $consanguineos->CI_RUN->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Expedido->Visible) { // Expedido ?>
	<div id="r_Expedido" class="form-group">
		<label for="x_Expedido" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Expedido"><?php echo $consanguineos->Expedido->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Expedido->CellAttributes() ?>>
			<span id="el_consanguineos_Expedido">
<input type="text" data-table="consanguineos" data-field="x_Expedido" name="x_Expedido" id="x_Expedido" size="30" maxlength="4" placeholder="<?php echo ew_HtmlEncode($consanguineos->Expedido->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Expedido->EditValue ?>"<?php echo $consanguineos->Expedido->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Nombres1->Visible) { // Nombres1 ?>
	<div id="r_Nombres1" class="form-group">
		<label for="x_Nombres1" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Nombres1"><?php echo $consanguineos->Nombres1->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Nombres1->CellAttributes() ?>>
			<span id="el_consanguineos_Nombres1">
<input type="text" data-table="consanguineos" data-field="x_Nombres1" name="x_Nombres1" id="x_Nombres1" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($consanguineos->Nombres1->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Nombres1->EditValue ?>"<?php echo $consanguineos->Nombres1->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Apellido_Paterno1->Visible) { // Apellido_Paterno1 ?>
	<div id="r_Apellido_Paterno1" class="form-group">
		<label for="x_Apellido_Paterno1" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Apellido_Paterno1"><?php echo $consanguineos->Apellido_Paterno1->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Apellido_Paterno1->CellAttributes() ?>>
			<span id="el_consanguineos_Apellido_Paterno1">
<input type="text" data-table="consanguineos" data-field="x_Apellido_Paterno1" name="x_Apellido_Paterno1" id="x_Apellido_Paterno1" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($consanguineos->Apellido_Paterno1->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Apellido_Paterno1->EditValue ?>"<?php echo $consanguineos->Apellido_Paterno1->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Apellido_Materno1->Visible) { // Apellido_Materno1 ?>
	<div id="r_Apellido_Materno1" class="form-group">
		<label for="x_Apellido_Materno1" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Apellido_Materno1"><?php echo $consanguineos->Apellido_Materno1->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Apellido_Materno1->CellAttributes() ?>>
			<span id="el_consanguineos_Apellido_Materno1">
<input type="text" data-table="consanguineos" data-field="x_Apellido_Materno1" name="x_Apellido_Materno1" id="x_Apellido_Materno1" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($consanguineos->Apellido_Materno1->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Apellido_Materno1->EditValue ?>"<?php echo $consanguineos->Apellido_Materno1->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Fiscalia_otro->Visible) { // Fiscalia_otro ?>
	<div id="r_Fiscalia_otro" class="form-group">
		<label for="x_Fiscalia_otro" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Fiscalia_otro"><?php echo $consanguineos->Fiscalia_otro->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Fiscalia_otro->CellAttributes() ?>>
			<span id="el_consanguineos_Fiscalia_otro">
<input type="text" data-table="consanguineos" data-field="x_Fiscalia_otro" name="x_Fiscalia_otro" id="x_Fiscalia_otro" size="30" maxlength="120" placeholder="<?php echo ew_HtmlEncode($consanguineos->Fiscalia_otro->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Fiscalia_otro->EditValue ?>"<?php echo $consanguineos->Fiscalia_otro->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Unidad_Organizacional->Visible) { // Unidad_Organizacional ?>
	<div id="r_Unidad_Organizacional" class="form-group">
		<label for="x_Unidad_Organizacional" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Unidad_Organizacional"><?php echo $consanguineos->Unidad_Organizacional->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Unidad_Organizacional->CellAttributes() ?>>
			<span id="el_consanguineos_Unidad_Organizacional">
<input type="text" data-table="consanguineos" data-field="x_Unidad_Organizacional" name="x_Unidad_Organizacional" id="x_Unidad_Organizacional" size="30" maxlength="70" placeholder="<?php echo ew_HtmlEncode($consanguineos->Unidad_Organizacional->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Unidad_Organizacional->EditValue ?>"<?php echo $consanguineos->Unidad_Organizacional->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Cargo->Visible) { // Cargo ?>
	<div id="r_Cargo" class="form-group">
		<label for="x_Cargo" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Cargo"><?php echo $consanguineos->Cargo->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Cargo->CellAttributes() ?>>
			<span id="el_consanguineos_Cargo">
<input type="text" data-table="consanguineos" data-field="x_Cargo" name="x_Cargo" id="x_Cargo" size="30" maxlength="70" placeholder="<?php echo ew_HtmlEncode($consanguineos->Cargo->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Cargo->EditValue ?>"<?php echo $consanguineos->Cargo->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Unidad->Visible) { // Unidad ?>
	<div id="r_Unidad" class="form-group">
		<label for="x_Unidad" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Unidad"><?php echo $consanguineos->Unidad->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Unidad->CellAttributes() ?>>
			<span id="el_consanguineos_Unidad">
<input type="text" data-table="consanguineos" data-field="x_Unidad" name="x_Unidad" id="x_Unidad" size="30" maxlength="70" placeholder="<?php echo ew_HtmlEncode($consanguineos->Unidad->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Unidad->EditValue ?>"<?php echo $consanguineos->Unidad->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Nombres->Visible) { // Nombres ?>
	<div id="r_Nombres" class="form-group">
		<label for="x_Nombres" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Nombres"><?php echo $consanguineos->Nombres->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Nombres->CellAttributes() ?>>
			<span id="el_consanguineos_Nombres">
<input type="text" data-table="consanguineos" data-field="x_Nombres" name="x_Nombres" id="x_Nombres" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($consanguineos->Nombres->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Nombres->EditValue ?>"<?php echo $consanguineos->Nombres->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Apellido_Paterno->Visible) { // Apellido_Paterno ?>
	<div id="r_Apellido_Paterno" class="form-group">
		<label for="x_Apellido_Paterno" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Apellido_Paterno"><?php echo $consanguineos->Apellido_Paterno->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Apellido_Paterno->CellAttributes() ?>>
			<span id="el_consanguineos_Apellido_Paterno">
<input type="text" data-table="consanguineos" data-field="x_Apellido_Paterno" name="x_Apellido_Paterno" id="x_Apellido_Paterno" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($consanguineos->Apellido_Paterno->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Apellido_Paterno->EditValue ?>"<?php echo $consanguineos->Apellido_Paterno->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Apellido_Materno->Visible) { // Apellido_Materno ?>
	<div id="r_Apellido_Materno" class="form-group">
		<label for="x_Apellido_Materno" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Apellido_Materno"><?php echo $consanguineos->Apellido_Materno->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Apellido_Materno->CellAttributes() ?>>
			<span id="el_consanguineos_Apellido_Materno">
<input type="text" data-table="consanguineos" data-field="x_Apellido_Materno" name="x_Apellido_Materno" id="x_Apellido_Materno" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($consanguineos->Apellido_Materno->getPlaceHolder()) ?>" value="<?php echo $consanguineos->Apellido_Materno->EditValue ?>"<?php echo $consanguineos->Apellido_Materno->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($consanguineos->Parentesco->Visible) { // Parentesco ?>
	<div id="r_Parentesco" class="form-group">
		<label for="x_Parentesco" class="<?php echo $consanguineos_search->SearchLabelClass ?>"><span id="elh_consanguineos_Parentesco"><?php echo $consanguineos->Parentesco->FldCaption() ?></span>	
		...
		<div class="<?php echo $consanguineos_search->SearchRightColumnClass ?>"><div<?php echo $consanguineos->Parentesco->CellAttributes() ?>>
			<span id="el_consanguineos_Parentesco">
<select data-table="consanguineos" data-field="x_Parentesco" data-value-separator="<?php echo $consanguineos->Parentesco->DisplayValueSeparatorAttribute() ?>" id="x_Parentesco" name="x_Parentesco"<?php echo $consanguineos->Parentesco->EditAttributes() ?>>
<?php echo $consanguineos->Parentesco->SelectOptionListHtml("x_Parentesco") ?>
</select>
</span>
		</div></div>
	</div>
...
<script type="text/javascript">
fconsanguineossearch.Init();
</script>
<?php
$consanguineos_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$consanguineos_search->Page_Terminate();
?>
