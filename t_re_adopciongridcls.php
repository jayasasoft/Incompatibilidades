...
$t_re_adopcion_grid = NULL; // Initialize page object first

class ct_re_adopcion_grid extends ct_re_adopcion {
	...
	// Page object name
	var $PageObjName = 't_re_adopcion_grid';

	// Grid form hidden field names
	var $FormName = 'ft_re_adopciongrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_re_adopcion"];
