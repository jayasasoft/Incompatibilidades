...
$declaraciones_view = NULL; // Initialize page object first

class cdeclaraciones_view extends cdeclaraciones {
	...
	// Page object name
	var $PageObjName = 'declaraciones_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["Id"] <> "") {
				...
				$sReturnUrl = "declaracioneslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "declaracioneslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "declaracioneslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($declaraciones_view)) $declaraciones_view = new cdeclaraciones_view();

// Page init
$declaraciones_view->Page_Init();

// Page main
$declaraciones_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$declaraciones_view->Page_Render();
?>
...
var CurrentForm = fdeclaracionesview = new ew_Form("fdeclaracionesview", "view");

// Form_CustomValidate event
fdeclaracionesview.Form_CustomValidate = 
...
fdeclaracionesview.ValidateRequired = true;
<?php } else { ?>
fdeclaracionesview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdeclaracionesview.Lists["x_Fiscalia_otro"] = {"LinkField":"x_denominacion","Ajax":true,"AutoFill":false,"DisplayFields":["x_Departamento","x_denominacion","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_fiscalias"};
...
<?php if ($declaraciones->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$declaraciones_view->IsModal) { ?>
<?php if ($declaraciones->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $declaraciones_view->ExportOptions->Render("body") ?>
<?php
	foreach ($declaraciones_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$declaraciones_view->IsModal) { ?>
<?php if ($declaraciones->Export == "") { ?>
...
<?php } ?>
<?php $declaraciones_view->ShowPageHeader(); ?>
<?php
$declaraciones_view->ShowMessage();
?>
<form name="fdeclaracionesview" id="fdeclaracionesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($declaraciones_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $declaraciones_view->Token ?>">
<?php } ?>
...
<?php if ($declaraciones->CI_RUN->Visible) { // CI_RUN ?>
	<tr id="r_CI_RUN">
		<td><span id="elh_declaraciones_CI_RUN"><?php echo $declaraciones->CI_RUN->FldCaption() ?></span></td>
...
<?php echo $declaraciones->CI_RUN->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Expedido1->Visible) { // Expedido1 ?>
	<tr id="r_Expedido1">
		<td><span id="elh_declaraciones_Expedido1"><?php echo $declaraciones->Expedido1->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Expedido1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Apellido_Paterno3->Visible) { // Apellido_Paterno3 ?>
	<tr id="r_Apellido_Paterno3">
		<td><span id="elh_declaraciones_Apellido_Paterno3"><?php echo $declaraciones->Apellido_Paterno3->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Apellido_Paterno3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Apellido_Materno3->Visible) { // Apellido_Materno3 ?>
	<tr id="r_Apellido_Materno3">
		<td><span id="elh_declaraciones_Apellido_Materno3"><?php echo $declaraciones->Apellido_Materno3->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Apellido_Materno3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Nombres2->Visible) { // Nombres2 ?>
	<tr id="r_Nombres2">
		<td><span id="elh_declaraciones_Nombres2"><?php echo $declaraciones->Nombres2->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Nombres2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Fecha->Visible) { // Fecha ?>
	<tr id="r_Fecha">
		<td><span id="elh_declaraciones_Fecha"><?php echo $declaraciones->Fecha->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Fiscalia_otro->Visible) { // Fiscalia_otro ?>
	<tr id="r_Fiscalia_otro">
		<td><span id="elh_declaraciones_Fiscalia_otro"><?php echo $declaraciones->Fiscalia_otro->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Fiscalia_otro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Unidad_Organizacional->Visible) { // Unidad_Organizacional ?>
	<tr id="r_Unidad_Organizacional">
		<td><span id="elh_declaraciones_Unidad_Organizacional"><?php echo $declaraciones->Unidad_Organizacional->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Unidad_Organizacional->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Unidad->Visible) { // Unidad ?>
	<tr id="r_Unidad">
		<td><span id="elh_declaraciones_Unidad"><?php echo $declaraciones->Unidad->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Unidad->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Cargo->Visible) { // Cargo ?>
	<tr id="r_Cargo">
		<td><span id="elh_declaraciones_Cargo"><?php echo $declaraciones->Cargo->FldCaption() ?></span></td>
...
<?php echo $declaraciones->Cargo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($declaraciones->Archivo->Visible) { // Archivo ?>
	<tr id="r_Archivo">
		<td><span id="elh_declaraciones_Archivo"><?php echo $declaraciones->Archivo->FldCaption() ?></span></td>
...
<?php if ((!ew_EmptyStr($declaraciones->Archivo->ViewValue)) && $declaraciones->Archivo->LinkAttributes() <> "") { ?>
<a<?php echo $declaraciones->Archivo->LinkAttributes() ?>><?php echo $declaraciones->Archivo->ViewValue ?></a>
<?php } else { ?>
<?php echo $declaraciones->Archivo->ViewValue ?>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($declaraciones->Export == "") { ?>
<script type="text/javascript">
fdeclaracionesview.Init();
</script>
<?php } ?>
<?php
$declaraciones_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($declaraciones->Export == "") { ?>
...
<?php
$declaraciones_view->Page_Terminate();
?>
