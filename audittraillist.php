...
<form name="faudittraillist" id="faudittraillist" class="form-horizontal ewForm ewListForm ewMultiColumnForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
?>
<?php echo $audittrail_list->MultiColumnBeginGrid() ?>
<div class="<?php echo $audittrail_list->MultiColumnClass ?>"<?php echo $audittrail->RowAttributes() ?>>
	...
	<?php if ($audittrail->id->Visible) { // id ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail_id">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->id) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->id->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->id) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_id">
...
<?php echo $audittrail->id->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail_id">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->id->FldCaption() ?></label>
...
<?php echo $audittrail->id->ListViewValue() ?></span>
	...
	<?php if ($audittrail->datetime->Visible) { // datetime ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail_datetime">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->datetime) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->datetime->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->datetime) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_datetime">
...
<?php echo $audittrail->datetime->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail_datetime">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->datetime->FldCaption() ?></label>
...
<?php echo $audittrail->datetime->ListViewValue() ?></span>
	...
	<?php if ($audittrail->script->Visible) { // script ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail_script">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->script) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->script->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->script) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_script">
...
<?php echo $audittrail->script->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail_script">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->script->FldCaption() ?></label>
...
<?php echo $audittrail->script->ListViewValue() ?></span>
	...
	<?php if ($audittrail->user->Visible) { // user ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail_user">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->user) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->user->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->user) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_user">
...
<?php echo $audittrail->user->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail_user">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->user->FldCaption() ?></label>
...
<?php echo $audittrail->user->ListViewValue() ?></span>
	...
	<?php if ($audittrail->action->Visible) { // action ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail_action">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->action) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->action->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->action) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail_action">
...
<?php echo $audittrail->action->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail_action">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->action->FldCaption() ?></label>
...
<?php echo $audittrail->action->ListViewValue() ?></span>
	...
	<?php if ($audittrail->_table->Visible) { // table ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail__table">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->_table) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->_table->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->_table) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail__table">
...
<?php echo $audittrail->_table->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail__table">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->_table->FldCaption() ?></label>
...
<?php echo $audittrail->_table->ListViewValue() ?></span>
	...
	<?php if ($audittrail->_field->Visible) { // field ?>
		<?php if ($audittrail->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="audittrail__field">
<?php if ($audittrail->Export <> "" || $audittrail->SortUrl($audittrail->_field) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $audittrail->_field->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $audittrail->SortUrl($audittrail->_field) ?>',1);">
...
<span id="el<?php echo $audittrail_list->RowCnt ?>_audittrail__field">
...
<?php echo $audittrail->_field->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group audittrail__field">
			<label class="col-sm-2 control-label ewLabel"><?php echo $audittrail->_field->FldCaption() ?></label>
...
$audittrail_list->ListOptions->Render("body", "", $audittrail_list->RowCnt);
?>
</div>
<div class="clearfix"></div>
</div>
...
?>
<?php echo $audittrail_list->MultiColumnEndGrid() ?>
<div class="clearfix"></div>
<?php } ?>
