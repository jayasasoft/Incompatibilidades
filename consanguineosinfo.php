...
//
// Table class for consanguineos
//
class cconsanguineos extends cTable {
	var $CI_RUN;
	var $Expedido;
	var $Nombres1;
	...
	function __construct() {
		...
		$this->TableVar = 'consanguineos';
		$this->TableName = 'consanguineos';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`consanguineos`";
		$this->DBID = 'DB';
		...
		// CI_RUN
		$this->CI_RUN = new cField('consanguineos', 'consanguineos', 'x_CI_RUN', 'CI_RUN', '`CI_RUN`', '`CI_RUN`', 200, -1, FALSE, '`CI_RUN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CI_RUN->Sortable = TRUE; // Allow sort
		$this->fields['CI_RUN'] = &$this->CI_RUN;

		// Expedido
		$this->Expedido = new cField('consanguineos', 'consanguineos', 'x_Expedido', 'Expedido', '`Expedido`', '`Expedido`', 200, -1, FALSE, '`Expedido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Expedido->Sortable = TRUE; // Allow sort
		$this->fields['Expedido'] = &$this->Expedido;

		// Nombres1
		$this->Nombres1 = new cField('consanguineos', 'consanguineos', 'x_Nombres1', 'Nombres1', '`Nombres1`', '`Nombres1`', 200, -1, FALSE, '`Nombres1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombres1->Sortable = TRUE; // Allow sort
		$this->fields['Nombres1'] = &$this->Nombres1;

		// Apellido_Paterno1
		$this->Apellido_Paterno1 = new cField('consanguineos', 'consanguineos', 'x_Apellido_Paterno1', 'Apellido_Paterno1', '`Apellido_Paterno1`', '`Apellido_Paterno1`', 200, -1, FALSE, '`Apellido_Paterno1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Paterno1->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Paterno1'] = &$this->Apellido_Paterno1;

		// Apellido_Materno1
		$this->Apellido_Materno1 = new cField('consanguineos', 'consanguineos', 'x_Apellido_Materno1', 'Apellido_Materno1', '`Apellido_Materno1`', '`Apellido_Materno1`', 200, -1, FALSE, '`Apellido_Materno1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Materno1->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Materno1'] = &$this->Apellido_Materno1;

		// Fiscalia_otro
		$this->Fiscalia_otro = new cField('consanguineos', 'consanguineos', 'x_Fiscalia_otro', 'Fiscalia_otro', '`Fiscalia_otro`', '`Fiscalia_otro`', 200, -1, FALSE, '`Fiscalia_otro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Fiscalia_otro->Sortable = TRUE; // Allow sort
		$this->fields['Fiscalia_otro'] = &$this->Fiscalia_otro;

		// Unidad_Organizacional
		$this->Unidad_Organizacional = new cField('consanguineos', 'consanguineos', 'x_Unidad_Organizacional', 'Unidad_Organizacional', '`Unidad_Organizacional`', '`Unidad_Organizacional`', 200, -1, FALSE, '`Unidad_Organizacional`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Unidad_Organizacional->Sortable = TRUE; // Allow sort
		$this->fields['Unidad_Organizacional'] = &$this->Unidad_Organizacional;

		// Cargo
		$this->Cargo = new cField('consanguineos', 'consanguineos', 'x_Cargo', 'Cargo', '`Cargo`', '`Cargo`', 200, -1, FALSE, '`Cargo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Cargo->Sortable = TRUE; // Allow sort
		$this->fields['Cargo'] = &$this->Cargo;

		// Unidad
		$this->Unidad = new cField('consanguineos', 'consanguineos', 'x_Unidad', 'Unidad', '`Unidad`', '`Unidad`', 200, -1, FALSE, '`Unidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Unidad->Sortable = TRUE; // Allow sort
		$this->fields['Unidad'] = &$this->Unidad;

		// Nombres
		$this->Nombres = new cField('consanguineos', 'consanguineos', 'x_Nombres', 'Nombres', '`Nombres`', '`Nombres`', 200, -1, FALSE, '`Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Nombres'] = &$this->Nombres;

		// Apellido_Paterno
		$this->Apellido_Paterno = new cField('consanguineos', 'consanguineos', 'x_Apellido_Paterno', 'Apellido_Paterno', '`Apellido_Paterno`', '`Apellido_Paterno`', 200, -1, FALSE, '`Apellido_Paterno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Paterno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Paterno'] = &$this->Apellido_Paterno;

		// Apellido_Materno
		$this->Apellido_Materno = new cField('consanguineos', 'consanguineos', 'x_Apellido_Materno', 'Apellido_Materno', '`Apellido_Materno`', '`Apellido_Materno`', 200, -1, FALSE, '`Apellido_Materno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Materno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Materno'] = &$this->Apellido_Materno;

		// Parentesco
		$this->Parentesco = new cField('consanguineos', 'consanguineos', 'x_Parentesco', 'Parentesco', '`Parentesco`', '`Parentesco`', 200, -1, FALSE, '`Parentesco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`consanguineos`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("consanguineosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("consanguineosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "consanguineosadd.php?" . $this->UrlParm($parm);
		else
			$url = "consanguineosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("consanguineosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("consanguineosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("consanguineosdelete.php", $this->UrlParm());
	}
