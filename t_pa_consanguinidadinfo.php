...
$t_pa_consanguinidad = NULL;

//
// Table class for t_pa_consanguinidad
//
class ct_pa_consanguinidad extends cTable {
	var $Id;
	var $Nombres;
	...
	function __construct() {
		...
		$this->TableVar = 't_pa_consanguinidad';
		$this->TableName = 't_pa_consanguinidad';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_pa_consanguinidad`";
		$this->DBID = 'DB';
		...
		// Id
		$this->Id = new cField('t_pa_consanguinidad', 't_pa_consanguinidad', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Id->Sortable = TRUE; // Allow sort
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// Nombres
		$this->Nombres = new cField('t_pa_consanguinidad', 't_pa_consanguinidad', 'x_Nombres', 'Nombres', '`Nombres`', '`Nombres`', 200, -1, FALSE, '`Nombres`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nombres->Sortable = TRUE; // Allow sort
		$this->fields['Nombres'] = &$this->Nombres;

		// Apellido_Paterno
		$this->Apellido_Paterno = new cField('t_pa_consanguinidad', 't_pa_consanguinidad', 'x_Apellido_Paterno', 'Apellido_Paterno', '`Apellido_Paterno`', '`Apellido_Paterno`', 200, -1, FALSE, '`Apellido_Paterno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Paterno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Paterno'] = &$this->Apellido_Paterno;

		// Apellido_Materno
		$this->Apellido_Materno = new cField('t_pa_consanguinidad', 't_pa_consanguinidad', 'x_Apellido_Materno', 'Apellido_Materno', '`Apellido_Materno`', '`Apellido_Materno`', 200, -1, FALSE, '`Apellido_Materno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Apellido_Materno->Sortable = TRUE; // Allow sort
		$this->fields['Apellido_Materno'] = &$this->Apellido_Materno;

		// Parentesco
		$this->Parentesco = new cField('t_pa_consanguinidad', 't_pa_consanguinidad', 'x_Parentesco', 'Parentesco', '`Parentesco`', '`Parentesco`', 200, -1, FALSE, '`Parentesco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_pa_consanguinidad`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_pa_consanguinidadlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_pa_consanguinidadview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_pa_consanguinidadview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_pa_consanguinidadadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_pa_consanguinidadadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_pa_consanguinidadedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_pa_consanguinidadadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_pa_consanguinidaddelete.php", $this->UrlParm());
	}
